    ...
    <div className="space-y-6 animate-fade-in">
      ...
      >
        {placed.length === 0 && state === "idle" && (
          <span className="text-gray-600 text-sm italic self-center dark:text-gray-300">
      ...
      {state === "idle" && (
        <div className="flex gap-3">
          ...
          <button
            ...
            className="btn-primary disabled:bg-gray-200 disabled:text-gray-600 text-sm dark:text-gray-300"
