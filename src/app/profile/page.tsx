      ...
      <main className="max-w-3xl mx-auto px-4 py-8 space-y-6">
                      ...
                      <div className="card group-hover:-translate-y-0.5 transition-transform duration-200">
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div className="flex-1">
                            ...
                            <p className="text-sm text-sv-800 dark:text-gray-300">{stage.grades}</p>
                          </div>
                          <div className="text-right">
                            <div className="font-bold text-amber-700 dark:text-amber-400">⭐ {totalPoints}</div>
                            <div className="text-xs text-sv-800 dark:text-gray-300">
                          ...
                          <div className="mt-3 grid grid-cols-2 gap-2">
                            {[
                              ...
                              <div key={label} className="bg-sv-50 dark:bg-gray-700 rounded-xl p-2 text-xs text-center border border-sv-100 dark:border-gray-600">
                                ...
                                <div className="text-sv-800 dark:text-gray-300">{label}</div>
                              </div>
                            ))}
                          </div>
                        )}
                ...
                return (
                  <div key={stage.id} className="card">
                    <div className="flex items-center gap-2 mb-3">
                      ...
                      <h3 className="font-bold text-sv-900 dark:text-gray-100">{stage.name}</h3>
                      <span className="ml-auto text-xs font-bold px-2 py-0.5 rounded-full bg-sv-100 dark:bg-gray-700 text-sv-800 dark:text-gray-300">
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="min-w-0">
                              <p className={`text-xs font-bold leading-tight ${unlocked ? "text-sv-900 dark:text-gray-100" : "text-sv-800 dark:text-gray-300"}`}>
                                {a.title}
                              </p>
                              <p className="text-xs text-sv-800 dark:text-gray-300 leading-tight truncate">{a.description}</p>
                            </div>
                          </div>
                        );
                      })}
        ...
        <BlurFade delay={0.25}>
          <div className="card mt-6">
            ...
            <p className="text-sm text-sv-800 dark:text-gray-300 mb-4">
