      ...
      <main className="max-w-5xl mx-auto px-4 py-4">
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm font-bold text-amber-700 dark:text-amber-400">
                  Du fick <span className="text-amber-700 dark:text-amber-300">⭐ {dailyBonus}</span> poäng för att du kom tillbaka idag. Bra jobbat! 🔥
                </p>
              </div>
            </div>
          </BlurFade>
        ...
        <BlurFade delay={0} className="mb-4">
          ...
          <p className="on-theme-muted text-sv-800 dark:text-gray-300 font-semibold mt-0.5">
            Välkommen tillbaka, <span className="text-sv-800 font-black dark:text-gray-200">{student.name}</span>! Totalt{" "}
            <span className="text-amber-700 font-black dark:text-amber-300">⭐ <NumberTicker value={student.totalPoints} className="text-amber-700 dark:text-amber-300" /></span> poäng.
          </p>
        </BlurFade>
