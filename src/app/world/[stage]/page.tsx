            ...
            {[
              ...
              return (
                ...
                >
                  ...
                  <div className={`text-base font-black leading-none ${done ? stage.textClass : "text-sv-800 dark:text-gray-100"}`}>{count}/{total}</div>
                  <div className="text-xs text-sv-800 dark:text-gray-300 mt-0.5 font-medium">{label}</div>
                </div>
              );
            })}
          </div>
      ...
      <main className="max-w-5xl mx-auto px-4 py-8">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-xl font-bold text-xs sm:text-sm whitespace-nowrap transition-all duration-200 cursor-pointer ${
                  activeTab === tab.id
                    ...
                    : "text-sv-800 dark:text-gray-300 hover:text-sv-800 dark:hover:text-gray-200 hover:bg-sv-50 dark:hover:bg-gray-700"
                }`}
            ...
            {retryItem ? (
              ...
              <div>
                <button
                  ...
                  className="inline-flex items-center gap-1.5 text-sv-800 dark:text-sv-700 hover:text-sv-800 dark:hover:text-sv-200 text-sm font-medium mb-4 transition-colors"
                >
                ...
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <div>
                    <div className="text-xs text-gray-600 dark:text-gray-300 uppercase tracking-wide font-semibold">
                ...
                {retryResult ? (
                  <div className={`card text-center py-10 ${retryResult === "correct" ? "border-green-300 bg-green-50 dark:bg-green-900/20" : "border-red-300 bg-red-50 dark:bg-red-900/20"}`}>
                    ...
                    {retryResult === "correct" && (
                      <p className="text-amber-700 dark:text-amber-400 font-black text-xl mt-2">
                        +{retryPoints} ⭐
                      </p>
                    )}
                    <button
                  ...
                  <div className="card">
                    <div key={retryItem.key}>
                      ...
                      {retryItem.exercise.type === "listen-spell" && (
                        <ListenSpell exercise={retryItem.exercise} onAnswer={handleRetryAnswer} isLast />
                      )}
                    </div>
                  </div>
                )}
              ...
              <div>
                ...
                {retryQueue.length === 0 ? (
                  <div className="card text-center py-12">
                    ...
                    <p className="text-gray-600 dark:text-gray-300 text-sm mt-1">Inga uppgifter att repetera just nu.</p>
                  </div>
                ) : (
                  <div className="space-y-2">
                    {retryQueue.map((item) => {
                      const preview =
                        ...
                        : item.exercise.type === "listen-spell" ? "🔊 Lyssna och stava ordet"
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2 mb-0.5">
                                ...
                                <span className="text-xs text-gray-500 dark:text-gray-300">{item.moduleTitle}</span>
                              </div>
                              <p className="text-sm text-gray-800 dark:text-gray-200 font-medium truncate">
                                {preview}
                              </p>
                            </div>
                            <span className="text-sv-800 group-hover:text-sv-800 transition-colors flex-shrink-0 dark:text-gray-200">→</span>
                          </div>
                        </button>
                      );
                    })}
        ...
        activeTab === "regler" ? (
          <div className="space-y-4">
            {rules.length === 0 ? (
              <div className="card text-center py-8 text-gray-600 dark:text-gray-300">Laddar regler...</div>
            ) : (
              rules.map((section) => (
                <details key={section.id} className="card group" open>
                  <summary className="flex items-center gap-3 cursor-pointer list-none select-none">
                    ...
                    <span className="text-gray-600 text-sm group-open:rotate-180 transition-transform duration-200 dark:text-gray-300">▼</span>
                  </summary>
          ...
          <div className="card text-center py-12 text-gray-600 dark:text-gray-300">
          ...
          <div className="space-y-6">
            ...
            {(content.spelling ?? []).length === 0 && (content.stavningstest ?? []).length === 0 && (
              <div className="card text-center py-10 text-gray-600 dark:text-gray-300">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            ...
            {activeTab === "wordsearch" && (content.wordsearch ?? []).length === 0 && (
              <div className="card text-center py-10 text-gray-600 col-span-1 sm:col-span-2 dark:text-gray-300">
