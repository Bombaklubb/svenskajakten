...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  { id: "lag-5",  stageId: "lagstadiet", icon: "🌾", title: "Ängsmästare",       description: "Klara 5 moduler i Ordängen. Belöning: 📦 Trälåda!" },
  ...
  { id: "lag-9",  stageId: "lagstadiet", icon: "🏆", title: "Ängshjälte",        description: "Klara 10 moduler i Ordängen. Belöning: 🪙 Silverlåda!" },
  { id: "lag-10", stageId: "lagstadiet", icon: "🌟", title: "Ängskung",          description: "Klara 18 moduler i Ordängen. Belöning: 🏆 Guldlåda!" },
  ...
  { id: "mel-5",  stageId: "mellanstadiet", icon: "🌳", title: "Skogsmästare",      description: "Klara 5 moduler i Berättelseskogen. Belöning: 📦 Trälåda!" },
  ...
  { id: "mel-9",  stageId: "mellanstadiet", icon: "🏆", title: "Skogshjälte",       description: "Klara 10 moduler i Berättelseskogen. Belöning: 🪙 Silverlåda!" },
  { id: "mel-10", stageId: "mellanstadiet", icon: "🌟", title: "Skogslegende",      description: "Klara 18 moduler i Berättelseskogen. Belöning: 🏆 Guldlåda!" },
  ...
  { id: "hog-5",  stageId: "hogstadiet", icon: "🔥", title: "Havskämpe",         description: "Klara 5 moduler i Texthavet. Belöning: 📦 Trälåda!" },
  ...
  { id: "hog-9",  stageId: "hogstadiet", icon: "🏆", title: "Havsmästare",       description: "Klara 10 moduler i Texthavet. Belöning: 🪙 Silverlåda!" },
  { id: "hog-10", stageId: "hogstadiet", icon: "🌟", title: "Havslegende",       description: "Klara 18 moduler i Texthavet. Belöning: 🏆 Guldlåda!" },
  ...
  { id: "gym-5",  stageId: "gymnasiet", icon: "🔥", title: "Akademikämpe",       description: "Klara 5 moduler i Skrivakademin. Belöning: 📦 Trälåda!" },
  ...
  { id: "gym-9",  stageId: "gymnasiet", icon: "🏆", title: "Akademimästare",     description: "Klara 10 moduler i Skrivakademin. Belöning: 🪙 Silverlåda!" },
  { id: "gym-10", stageId: "gymnasiet", icon: "🌟", title: "Akademilegende",     description: "Klara 18 moduler i Skrivakademin. Belöning: 🏆 Guldlåda!" },
  ...
  { id: "global-2", stageId: "global", icon: "💪", title: "Fleritdig",           description: "Klara moduler i 2 olika stadier. Belöning: 📦 Trälåda!" },
  { id: "global-3", stageId: "global", icon: "🌍", title: "Världserövrare",      description: "Klara moduler i alla 4 stadier. Belöning: 🪙 Silverlåda!" },
  { id: "global-4", stageId: "global", icon: "⭐", title: "100 poäng",           description: "Samla totalt 100 poäng." },
  { id: "global-5", stageId: "global", icon: "👑", title: "Mästaren",            description: "Samla totalt 500 poäng. Belöning: 🏆 Guldlåda!" },
  { id: "global-6", stageId: "global", icon: "⚽", title: "Fotbollsstjärnan",    description: "Klara 20 moduler totalt. Belöning: 🪙 Silverlåda!" },
  { id: "global-7", stageId: "global", icon: "🎓", title: "Svenskaexperten",     description: "Samla totalt 1000 poäng. Belöning: 🏆 Guldlåda!" },
];
