  ...
  },
  {
    ...
    questions: [
      ...
      { id: "gg7", type: "multiple-choice", category: "spelling",
        ...
        options: ["Sammanhang", "Samanhang", "Sammanhang", "Samanhand"],
        correctIndex: 0 },
      ...
      { id: "gg9", type: "multiple-choice", category: "grammar",
        ...
        options: ["Varken Erik eller Maja gillar glass.", "Varken Erik eller Maja gillar inte glass.", "Varken Erik och Maja gillar glass.", "Varken Erik eller Maja gillar glassen."],
        correctIndex: 0 },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "om6", type: "multiple-choice", category: "grammar",
        question: "Vilket suffix bildar ett adjektiv av substantivet 'färg'?",
        options: ["färgning", "färglig", "färgad", "färgig"],
        correctIndex: 3 },
      { id: "om7", type: "multiple-choice", category: "spelling",
        question: "Vilket ord stavas rätt?",
        options: ["Extraordinär", "Extraordinär", "Extraordenär", "Extraordiner"],
        correctIndex: 1 },
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "sp6", type: "multiple-choice", category: "grammar",
        question: "Vad innebär 'hyperbel' som stilfigur?",
      ...
      { id: "sp7", type: "multiple-choice", category: "grammar",
        question: "Vilken satstype är 'att han kom sent' i meningen 'Jag visste att han kom sent'?",
